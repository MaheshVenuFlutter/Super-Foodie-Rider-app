...
import 'package:food_rider/assistantMethods/get_current_location.dart';
import 'package:food_rider/global/global.dart';
import 'package:food_rider/mainScreens/parcel_delivering_screen.dart';
import 'package:food_rider/maps/map_utils.dart';
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              //Show restuirent location form rider current location
          ...
          Padding(
            ...
            child: Center(
              child: InkWell(
                onTap: () {
                  // Confirmed - the rider has picked the order from the resturent
                ...
                child: Container(
                  ...
                  child: const Center(
                    child: Text(
                      "Order has been Picekd - Confirmed",
